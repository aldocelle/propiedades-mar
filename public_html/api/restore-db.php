 ...
 * Acceder vía: https://propiedadesmar.cl/api/restore-db.php?token=restore2026
 */
...
try {
    ...
    $results[] = "Tabla properties creada";
    ...
    $results[] = "Tabla property_images creada";
